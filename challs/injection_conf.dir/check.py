...
def check(correction_file, secret):
    ...
    if ret != 0 or not os.path.isdir(directory) or not os.path.isfile(folder_configured_path):
        print("Your code should have created a directory with an init file \"folder_configured in it\". "
              "But it appears it failed to do it. Here is the output of your code : " + out)
        return False
